...
# Resolve relative path at import time
_BASE = os.path.join(os.path.dirname(__file__), "..", "..", "..", "..", "..")


class Ben25Dataset(BaseDocLabelDataset):
    ...
    def load(self) -> Tuple[List[str], List[Dict[str, str]]]:
        ...
        texts_path = os.path.join(self._data_root, "ben25", "ben25_texts.jsonl")
        labels_path = os.path.join(self._data_root, "ben25", "ben25_gpt52_labels.json")
